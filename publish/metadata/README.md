...
| [`personnel_csv_template/personnel.csv`](personnel_csv_template/personnel.csv) | CSV list of dataset creators and contacts; one row per person-role combination (roles: `creator`, `contact`) |
...
| [`attributes_csv_template/attributes_microhabitat_observations.csv`](attributes_csv_template/attributes_microhabitat_observations.csv) | Column-by-column definitions for each data table: name, description, class, units, missing value codes; one file per data table |
...
- [`personnel.txt`](personnel.txt) — generated from [`personnel_csv_template/personnel.csv`](personnel_csv_template/personnel.csv)
- `attributes_<table_name>.txt` — generated from [`attributes_csv_template/attributes_<table_name>.csv`](attributes_csv_template/attributes_microhabitat_observations.csv) (example)
...
- **[`attributes_csv_template/attributes_survey_locations.csv`](attributes_csv_template/attributes_survey_locations.csv)** is stubbed out but the corresponding data table (`survey_locations_clean.csv`) is not yet included in the example publication.
